...
<template>
  ...
  <div class="py-9">
    ...
    <div class="grid grid-cols-3 py-9 mx-auto max-w-330 gap-6">
      <SpotlightCard spotlight-color="rgba(255, 123, 0, 0.42)">
        <div class="flex flex-col items-center justify-center">
          ...
          <p class="jersey-10-regular text-[36px] text-white">lnwkit007</p>
        </div>
      </SpotlightCard>
      ...
      <SpotlightCard spotlight-color="rgba(255, 123, 0, 0.42)">
        <div class="flex flex-col items-center justify-center">
          ...
          <p class="jersey-10-regular text-[36px] text-white">Kitsada Ketrai</p>
        </div>
      </SpotlightCard>
